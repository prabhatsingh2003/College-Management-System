...
<html>
<head>
	<title>AKS University</title>
	<link rel="shortcut icon" href="./Images/akssym.png" type="image/x-icon">
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="images/akssym.png" class="logo-image" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">aks University</h3>
	</a>
