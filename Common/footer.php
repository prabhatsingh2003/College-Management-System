    ...
    <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12 segment-one md-mb-30 sm-mb-30">
            <h3>AKS College</h3>
            <p>This Project has been made by PRABHAT SINGH with the some help of 
               my friends.
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 segment-two md-mb-30 sm-mb-30">
            <h2>CONTACT DETAILS</h2>
              <p>Address: satna ,distt satna (M.P.),
                  Sher Ganj Town, Panna road, 480001 satna – India</p>
              <p>Telephones: (+91) 8602307571 </p>
              <p>E-mail: ps5701107@gmail.com</p>
        </div>
      </div>
    </div>
    </div>
  <p class="footer-bottom-text">By PRABHAT SINGH Programming and Code for College academics.2022</p>
</footer>